...
import TuningTabComp from './tuningtab';


const TuningClickComp = () => {
    const {id} = useParams();
    
    const master = tuningcar.masterdata.find(
   ...
   <Bgwrap>
    ...
    <div style={{marginTop: '100px'}}>
        <Flexwrap>   
            ...
            <LeftWrapper> 
        <img src={master.car.photo} alt="car" />
        </LeftWrapper>   
        <Rightwrapper>
           <Space $master>
           <h1>{master.car.name}</h1>
        <h2 style={{color:'#006DAB'}}>{master.car.cost}</h2>
           </Space>
           <Space>
            <p>Company</p>
            <p>{master.car.company}</p>
           </Space>
           <Space>
            <p>People</p>
            <p>{master.car.people}</p>
           </Space>
           <Space>
            <p>License type</p>
            <p>{master.car.license}</p>
           </Space>           
        </Rightwrapper>
...
export default TuningClickComp